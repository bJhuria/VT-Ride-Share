...
if(isset($_POST["submit"])){
    ...
    if(isset($_POST["Comments"])) $comment = $_POST["Comments"];
     ...
     $sql="update Ratings set Clean='$clean',Polite='$polite',Comfort='$comfort',Overall='$overall',Comments='$comment' where userid = $userid ";
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 col-xl-6 text-center mx-auto">
                    <h2>Update Rating</h2>
                    <p class="w-lg-50">Please update your rating using this form</p>
                </div>
            </div>
                        ...
                        <div class="card-body d-flex flex-column align-items-center" style="height: 600px;">
                            <form class="text-center" method="post" >
                                <div class="mb-3">
                                    ...
                                    <p>Driver ID</p><input class="form-control" type="text" name="userid" placeholder="Number" min="0" max="5" value="2">
                                    <p>Cleanliness of driver</p><input class="form-control" type="number" name="Clean" placeholder="Number" min="0" max="5" value="2">
                                </div>
                                <div class="mb-3">
                                    <p>Politeness of Driver</p><input class="form-control" type="number" name="Polite" placeholder="Password" min="1" max="5" value="4">
                                </div>
                                <div>
                                    <p>Rate how comfortable you would be with riding with this driver again<input class="form-control" name="Comfort" type="number" min="1" max="5" value="3"></p>
                                </div>
                                <div>
                                    <p>How would you rate this driver overall?</p><input class="form-control"name="Overall" type="number" min="1" max="5" value="3">
                                </div>
                                <div>
                                    <p>Leave any additional comments below<input class="form-control form-control-lg"name="Comments"  type="text"></p>
                                </div>
                                <div class="mb-3"></div>
                           <button class="btn btn-primary d-block w-100" name ="submit" type="submit" style="background: rgb(120, 194, 173);margin: 10px;">Submit</button>
                            <div></div><button class="btn btn-primary d-block w-100" id="delete" name="delete"  type="delete" style="margin: 10px;">Delete</button> </form>
                        </div>
                    </div>
                </div>
            </div>
